...
const CUSTOM_SRC =
  "https://images.unsplash.com/photo-1559828801-04565cd31e27?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGN5YmVycHVuayUyMGdpcmx8ZW58MHx8MHx8fDA%3D";
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="relative">
        <Avatar {...args}>
          <Avatar.Image alt="Online User" src={SAMPLE_SRC_2} />
          <Avatar.Fallback>ON</Avatar.Fallback>
        </Avatar>

        <span className="absolute top-0 right-0 size-2.5 rounded-full bg-success ring-2 ring-background" />
      </div>

      <div className="relative">
        <Avatar {...args}>
          <Avatar.Image alt="Online User" src={SAMPLE_SRC_3} />
          <Avatar.Fallback>ON</Avatar.Fallback>
        </Avatar>
