...
const Default: Story = {
  args: {
    children: [<AvatarImage key="img" alt="Colm Tuite" src={SAMPLE_AVATAR_1} />],
  },
};
  ...
  render: (args): React.JSX.Element => (
    <>
      <Avatar {...args} radius="none">
        <AvatarImage alt="Avatar" src={SAMPLE_AVATAR_1} />
  ...
  render: (args): React.JSX.Element => (
    <>
      ...
      <Avatar {...args} ring="success">
        <AvatarImage alt="Nova Vega" src={SAMPLE_AVATAR_1} />
        <AvatarFallback>NV</AvatarFallback>
      </Avatar>

      <Avatar {...args} ring="warning">
        <AvatarImage alt="Iris Ono" src={SAMPLE_AVATAR_1} />
        <AvatarFallback>IO</AvatarFallback>
      </Avatar>

      <Avatar {...args} ring="danger">
        <AvatarImage alt="Zoe Xu" src={SAMPLE_AVATAR_1} />
...
const Disabled: Story = {
  args: {
    isDisabled: true,
    children: [
      <AvatarImage key="img" alt="Luna Park" src={SAMPLE_AVATAR_1} />,
...
const BrokenImage: Story = {
  args: {
    children: [
      <AvatarImage key="img" alt="Zoe Xu" src="https://broken.url/image.png" />,
