...
<div className="not-prose mb-6 flex flex-wrap gap-2">
  <a
    ...
    target="_blank"
    className="inline-flex items-center gap-[8.65px] border border-border bg-surface px-3.5 py-1.5 text-sm leading-none font-medium text-surface-foreground hover:bg-surface-hover"
  >
